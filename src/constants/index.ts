...
export const allowedNavigationLinks = [
    ...
    { href: '/notification/list', allowedRoles: [ROLE.superadmin], dynamic: false },
    { href: '/notification/create', allowedRoles: [ROLE.superadmin], dynamic: false },
    {
...
export const API_KEY_LABELS = {
    ...
    FINGERPRINT_SCORE_THRESHOLD: 'FINGERPRINT_SCORE_THRESHOLD',
    STRANGER_DETECTION: 'STRANGER_DETECTION',
