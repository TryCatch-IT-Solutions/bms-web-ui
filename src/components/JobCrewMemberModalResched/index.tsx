...
import { RescheduleJobType } from '@/api/job/schema'
import { Form } from '../Forms'
import { Button } from '../Button'

interface JobCrewMemberModalReschedProps {
    open: boolean
    setOpen: Dispatch<SetStateAction<boolean>>
    submit: (d: RescheduleJobType) => void
    methods: UseFormReturn<RescheduleJobType>
    onClose?: () => void
}

const JobCrewMemberModalResched: React.FC<JobCrewMemberModalReschedProps> = ({
    setOpen,
    open,
    submit,
    methods,
                    ...
                    <div className='flex gap-5 px-6 pt-10'>
                        ...
                        <div className=' overflow-auto'>
                            ...
                            <AlertDialogDescription className='text-left text-sm text-gray-500 mt-5'>
                                You are about to reschedule this job without assigning a crew. Don't worry
...
export default JobCrewMemberModalResched
