...
interface IRestoreProfileJobRestrictionModal {
    open: boolean
    setOpen: Dispatch<SetStateAction<boolean>>
    type: string
}

const RestoreProfileJobRestrictionModal: React.FC<IRestoreProfileJobRestrictionModal> = ({
    open,
    setOpen,
    type,
}) => {
                ...
                <div className='flex gap-5 px-10'>
                    ...
                    <div className=' overflow-auto'>
                        ...
                        <p className='text-left text-sm text-gray-500 mt-5'>
                            Oops! We can't reactivate the {type} right now because you don't have enough seats left.
                        </p>
                        
                        <p className='text-left text-sm text-gray-500 mt-5'>
                            Please delete existing user/s before attempting to reactivate.
...
export default RestoreProfileJobRestrictionModal
