...
export const PhoneNumberInput = forwardRef((props: PhoneNumberInputProps, forwardRef) => {
    ...
    return (
        <div className='relative'>
            <PhoneInput
                className={cn(
                    'w-full border border-zentive-gray-medium h-[45px] peer px-3 rounded-sm',
                    isFocused && !invalid && 'border-zentive-green-dark',
            ...
            <Label
                className={cn(
                    'floating-label absolute left-12 top-1/2 -translate-y-1/2 text-base text-zentive-gray-medium duration-100 ease-linear peer-has-[:focus]:left-3 peer-has-[:focus]:-translate-y-[2.15rem] peer-has-[:focus]:text-sm peer-has-[:focus]:px-1 split-color pointer-events-none',
