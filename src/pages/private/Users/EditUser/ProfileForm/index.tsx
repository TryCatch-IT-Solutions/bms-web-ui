    ...
    return (
        <div>
            <Form {...userForm}>
                ...
                >
                    <Card className=''>
                        <CardContent className='flex flex-col gap-5 xs:gap-7 sm:gap-7 pt-5'>
                            {isLoading ? (
                                ...
                                <>
                                    <div className='flex flex-row xs:flex-col sm:flex-col xs:gap-5 xs:gap-7 sm:gap-7 sm:flex-col sm:gap-5 gap-3 items-center justify-start'>
                                    ...
                                    <div className='flex flex-row xs:flex-col sm:flex-col gap-3 sm:gap-7 xs:gap-7 sm:gap-7 items-center justify-start'>
                                        <div className='w-1/3 xs:w-full sm:w-full'>
                                            <FormField
                                                control={userForm.control}
                                                name='email'
                                    ...
                                    <div className='flex flex-row xs:flex-col sm:flex-col gap-3 sm:gap-7 items-center justify-start'>
                                        <div className='w-1/3 xs:w-full sm:w-full max-w-[32.5%] sm:max-w-full xs:max-w-full'>
                                            <FormField
                                                control={userForm.control}
                                                name='role'
                                                render={({ field }) => (
                        ...
                        {!isLoading && (
                            <CardFooter className='flex flex-row gap-5 xs:gap-7 sm:gap-7 items-center justify-end'>
                                <Button
                                    variant='outline'
