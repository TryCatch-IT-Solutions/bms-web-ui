...
const ExportDropdown = ({ employeeListData, isDisabled }: IExportDropdown) => {
                ...
                {isOpen && (
                    <div className='mt-2 w-[150px] h-auto absolute right-0 z-10 origin-top-right rounded-md bg-white shadow-lg focus:outline-none'>
                        <div className='flex flex-col w-full rounded-md'>
                            <ExportEmployeePDF employeeListData={employeeListData} />
                            <ExportEmployeeCSV employeeListData={employeeListData} />
                        </div>
                    </div>
                )}
            </Menu>
