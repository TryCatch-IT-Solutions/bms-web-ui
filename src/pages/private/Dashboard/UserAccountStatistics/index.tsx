            ...
            <CardContent className='flex flex-row xs:flex-col sm:flex-col'>
                {isAdmin && (
                    <button
                        ...
                        className='flex flex-row items-center gap-5 text-bms-gray-500 hover:rounded-md border xs:border-0 sm:border-0 border-1 border-y-0 border-l-0 border-bms-gray-300 p-5 hover:bg-gray-100'
                    >
