        ...
        <Card className='w-fit'>
            ...
            <CardContent className='flex flex-row'>
                <button
                    ...
                    className='flex flex-row items-center gap-5 text-bms-gray-500 border border-1 border-y-0 border-l-0 border-bms-gray-300 p-5 hover:bg-gray-100'
                >
                ...
                <button
                    ...
                    className='flex flex-row items-center gap-5 text-bms-gray-500 p-5 hover:bg-gray-100'
                >
